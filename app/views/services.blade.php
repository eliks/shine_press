...
<html>
<head>
<title>Shine Prints | Services</title>
		 ...
		 <div class="logo">
			<a href="index">
				<div style="width: 145px; height: 40px;">
					<p style="font-size: 26px;font-family: serif;font-weight: 700;"> Shine Prints</p>
				</div>
		 ...
		 <div class="container">
		   <div class="classes_wrapper">
		 	<div class="row class_box">
 			  <div class="col-md-6">
				<div class="class_left">
					<a href="services"><img src="images/services/prepress1.jpg" class="img-responsive" alt=""/ title="continue"></a>
				</div>
				<div class="class_right">
					...
					<div class="class_img">
					   ...
					   <ul class="buttons_class">
					  	 <li class="btn7"><a href="#">Samples</a></li>	
				         <li class="btn8"><a href="#">Request Quote</a></li>	
			            <div class="clear"></div>
			           </ul>
					</div>
				</div>
			   ...
			   <div class="col-md-6">
				<div class="class_left">
					<a href="services"><img src="images/services/graphic_design1.jpg" class="img-responsive" alt=""/ title="continue"></a>
				</div>
			 ...
			 <div class="row class_box">
 			   <div class="col-md-6">
				<div class="class_left">
					<a href="services"><img src="images/services/color_seperation1.jpg" class="img-responsive" alt=""/ title="continue"></a>
				</div>
				<div class="class_right">
			   ...
			   <div class="col-md-6">
				<div class="class_left">
					<a href="services"><img src="images/services/book_binding1.jpg" class="img-responsive" alt=""/ title="continue"></a>
				</div>
				<div class="class_right1">
					<h3>Book Binding</h3>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
			 ...
			 <div class="row class_box1">
 			  <div class="col-md-6">
				<div class="class_left">
					<a href="services"><img src="images/services/commercial_printers1.jpg"  class="img-responsive" alt=""/ title="continue"></a>
				</div>
				<div class="class_right">
		   ...
		   <div class="container">
		 	 <div class="row section group">
				...
				<div id="semifooter" class="col-md-5 col-md-offset-1">
					...
					<div class="row">
						{{ Form::open(array('url' => 'submit_message_c')) }}
